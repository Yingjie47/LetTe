...
driver.find_element(By.XPATH, '/html/body/div[2]/div/div/div[2]/div/div[1]/div[4]/div/div[2]/div/div/ul/li/div[2]/div[3]/small/a[2]').click()
driver.find_element(By.XPATH, '//*[@id="news_comments-comment_message"]').send_keys("123")
