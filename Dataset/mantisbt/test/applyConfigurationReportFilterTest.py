...
driver.find_element(By.XPATH, '//*[@id="filter_form"]/div/div[2]/div[1]/div/table/tbody/tr/td[2]/select').click()
driver.find_element(By.XPATH, '//*[@id="filter_form"]/div/div[2]/div[1]/div/table/tbody/tr/td[2]/select/option[2]').click()
driver.find_element(By.XPATH, '//*[@id="filter_form"]/div/div[2]/div[1]/div/table/tbody/tr/td[3]/select').click()
driver.find_element(By.XPATH, '//*[@id="filter_form"]/div/div[2]/div[1]/div/table/tbody/tr/td[3]/select/option[2]').click()
driver.find_element(By.XPATH, '//*[@id="filter_form"]/div/div[2]/div[2]/div/div/input[1]').click()
# sleep(1)
