...
driver.find_element(By.XPATH, '//*[@id="download_admin"]/li[3]/a').click()
driver.find_element(By.XPATH, '//*[@id="tab-dlcats"]').click()
sleep(1)
driver.find_element(By.XPATH, '//*[@id="dlcats"]/div/div/div/div[1]/a[1]').click()
driver.find_element(By.XPATH, '//*[@id="download_cat_name"]').send_keys("123")
driver.find_element(By.XPATH, '//*[@id="download_cat_description"]').send_keys("123")
