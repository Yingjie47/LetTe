...
sleep(1)
driver.find_element(By.XPATH, '//a[contains(text()," Polls")]').click()
driver.find_element(By.XPATH, '/html/body/div[1]/div[1]/section[2]/div/div/div/div[2]/div/div/div[3]/div/button').click()
driver.find_element(By.XPATH, '//*[@id="tab-content-poll"]/div[2]/div/div/div[3]/div/ul/li[2]/a').click()
sleep(1)
