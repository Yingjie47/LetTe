...
sleep(1)
driver.find_element(By.XPATH, '/html/body/div[3]/div/div[2]/div/div[2]/div[2]/div/table/tbody/tr[1]/td[10]/a[1]').click()
sleep(1)
driver.find_element(By.XPATH, '//*[@id="new_password"]').send_keys("test@123")
driver.find_element(By.XPATH, '//*[@id="new_password_confirm"]').send_keys("test@123")
