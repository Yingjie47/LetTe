...
driver.find_element(By.XPATH, '//*[@id="download_admin"]/li[4]/a').click()
driver.find_element(By.XPATH, '//*[@id="tab-content-download_admin"]/div[2]/table/tbody/tr/td[4]/a').click()
