...
driver.find_element(By.XPATH, '/html/body/div[3]/div/div[2]/div/div[2]/div[1]/div/div/a[2]').click()
driver.find_element(By.XPATH, '//*[@id="dat_all_day_group"]/div/div/label').click()
driver.find_element(By.XPATH, '//*[@id="dat_highlight_group"]/div/div/label').click()
