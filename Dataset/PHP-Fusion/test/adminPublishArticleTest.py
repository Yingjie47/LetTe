...
driver.find_element(By.XPATH, '/html/body/div[1]/div[1]/section[2]/div/div/div/form/div[1]/table/tbody/tr/td[1]/div/div/input').click()
driver.find_element(By.XPATH, '//*[@id="article_filter"]/div[1]/div[1]/button[1]').click()
# sleep(1)
