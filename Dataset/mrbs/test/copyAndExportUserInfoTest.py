...
driver.find_element(By.XPATH, '//*[@id="users_table_wrapper"]/div[1]/button[2]').click()
driver.find_element(By.XPATH, '//*[@id="users_table_wrapper"]/div[1]/button[3]').click()
driver.find_element(By.XPATH, '//*[@id="users_table_wrapper"]/div[1]/button[4]').click()
driver.find_element(By.XPATH, '//*[@id="users_table_wrapper"]/div[1]/button[5]').click()
driver.find_element(By.XPATH, '//*[@id="users_table_wrapper"]/div[1]/button[6]').click()
# sleep(1)
