...
driver.find_element(By.XPATH, '//*[@id="edit_faq_cat"]').click()
driver.find_element(By.XPATH, '//*[@id="faq_cat_name"]').send_keys("123")
driver.find_element(By.XPATH, '//*[@id="faq_cat_description"]').send_keys("123")
