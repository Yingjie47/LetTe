...
driver.find_element(By.XPATH, '//*[@id="articles_admin"]/li[1]/a').click()
driver.find_element(By.XPATH, '//*[@id="article_filter"]/div[1]/div[1]/a').click()
driver.find_element(By.XPATH, '//*[@id="article_subject"]').send_keys("test")
driver.find_element(By.XPATH, '//*[@id="tab-snippet"]').click()
driver.find_element(By.XPATH, '//*[@id="article_snippet"]').send_keys("test")
driver.find_element(By.XPATH, '//*[@id="tab-extended"]').click()
sleep(1)
driver.find_element(By.XPATH, '//*[@id="article_article"]').send_keys("test")
driver.find_element(By.XPATH, '//*[@id="s2id_article_cat"]/a').click()
driver.find_element(By.XPATH, '//div[contains(text()," test123 ")]').click()
