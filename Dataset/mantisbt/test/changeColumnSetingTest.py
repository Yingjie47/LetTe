...
driver.find_element(By.XPATH, '//*[@id="csv-columns"]').send_keys(", notes")
driver.find_element(By.XPATH, '//*[@id="excel-columns"]').send_keys(", notes")
driver.find_element(By.XPATH, '//*[@id="manage-columns-form"]/div/div[2]/input').click()
# sleep(1)
