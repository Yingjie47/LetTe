...
driver.find_element(By.XPATH, '//*[@id="tab-content-rank_admin"]/div/table/tbody/tr[1]/td[5]/a[1]').click()
driver.find_element(By.XPATH, '//*[@id="rank_title"]').send_keys("123")
driver.find_element(By.XPATH, '//*[@id="s2id_rank_image"]/a').click()
