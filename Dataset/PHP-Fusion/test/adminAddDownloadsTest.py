...
driver.find_element(By.XPATH, '//*[@id="download_admin"]/li[2]/a').click()
driver.find_element(By.XPATH, '//*[@id="download_title"]').send_keys("test")
driver.find_element(By.XPATH, '//*[@id="download_description_short"]').send_keys("test")
driver.find_element(By.XPATH, '//*[@id="tab-dll"]').click()
sleep(1)
driver.find_element(By.XPATH, '//*[@id="download_url"]').send_keys("http://cn.bing.com/")
