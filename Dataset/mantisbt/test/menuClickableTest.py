...
# sleep(1)
driver.find_element(By.XPATH, '//*[@id="sidebar"]/ul/li[1]/a').click()
driver.find_element(By.XPATH, '//*[@id="sidebar"]/ul/li[2]/a').click()
driver.find_element(By.XPATH, '//*[@id="sidebar"]/ul/li[3]/a').click()
driver.find_element(By.XPATH, '//*[@id="sidebar"]/ul/li[4]/a').click()
driver.find_element(By.XPATH, '//*[@id="sidebar"]/ul/li[5]/a').click()
driver.find_element(By.XPATH, '//*[@id="sidebar"]/ul/li[6]/a').click()
# sleep(1)
