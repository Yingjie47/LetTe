...
sleep(1)
ActionChains(driver).move_to_element(driver.find_element(By.XPATH, '/html/body/div[1]/div[2]/div[2]/div/div[1]/div[4]/div[2]/div[1]/div/div/ul/li[1]/div')).perform()
driver.find_element(By.XPATH, '/html/body/div[1]/div[2]/div[2]/div/div[1]/div[4]/div[2]/div[1]/div/div/ul/li[1]/div/table/tbody/tr[1]/td[3]/div/a[2]').click()
sleep(1)
