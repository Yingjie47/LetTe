...
driver.find_element(By.XPATH, '//*[@id="gallery_admin"]/li[3]/a').click()
driver.find_element(By.XPATH, '//*[@id="album_title"]').send_keys("test")
driver.find_element(By.XPATH, '//*[@id="album_description"]').send_keys("test")
