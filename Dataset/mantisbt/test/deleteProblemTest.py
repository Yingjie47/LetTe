...
driver.find_element(By.XPATH, '//*[@id="main-container"]/div[2]/div[2]/div/div[1]/div/div[2]/div[2]/div/table/tfoot/tr/td/div/div[9]/form/fieldset/input[4]').click()
driver.find_element(By.XPATH, '//*[@id="action-group-div"]/form/div/div[2]/div[2]/input').click()
# sleep(1)
