...
driver.find_element(By.XPATH, '//*[@id="custom-field-link-project"]/td[2]/a').click()
driver.find_element(By.XPATH, '//*[@id="main-container"]/div[2]/div[2]/div/div/div[2]/form/input[6]').click()
# sleep(1)
