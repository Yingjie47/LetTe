...
driver.find_element(By.XPATH, '//*[@id="articles_admin"]/li[3]/a').click()
driver.find_element(By.XPATH, '//*[@id="tab-content-articles_admin"]/div/table/tbody/tr/td[5]/a').click()
driver.find_element(By.XPATH, '//*[@id="delete_submission-formstart"]').click()
# sleep(1)
