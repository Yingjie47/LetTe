...
driver.find_element(By.XPATH, '//*[@id="tab-content-download_admin"]/ul/li/div[2]/div[3]/a[2]').click()
driver.find_element(By.XPATH, '//*[@id="download_title"]').send_keys("123")
driver.find_element(By.XPATH, '//*[@id="download_description_short"]').send_keys("123")
driver.find_element(By.XPATH, '//*[@id="tab-dll"]').click()
sleep(1)
driver.find_element(By.XPATH, '//*[@id="download_url"]').clear()
