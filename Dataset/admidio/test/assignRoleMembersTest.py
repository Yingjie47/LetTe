...
driver.find_element(By.XPATH, '/html/body/div[3]/div/div[2]/div/div[2]/div[4]/div/div/ul/li[1]/a[2]').click()
sleep(1)
driver.find_element(By.XPATH, '/html/body/div[3]/div/div[2]/div/div[2]/div[2]/div/table/tbody/tr/td[2]/input').click()
driver.find_element(By.XPATH, '/html/body/div[3]/div/div[2]/div/div[2]/div[2]/div/table/tbody/tr/td[7]/input').click()
# sleep(1)
