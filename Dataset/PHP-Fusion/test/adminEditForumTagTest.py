...
driver.find_element(By.XPATH, '//*[@id="tab-content-rank_admin"]/div/div[1]/div/div[2]/span/a[1]').click()
driver.find_element(By.XPATH, '//*[@id="tag_title"]').send_keys("123")
driver.find_element(By.XPATH, '//*[@id="tag_description"]').send_keys("123")
driver.find_element(By.XPATH, '//*[@id="tag_status-field"]/div/div[2]/label').click()
driver.find_element(By.XPATH, '//*[@id="save_tag"]').click()
# sleep(1)
