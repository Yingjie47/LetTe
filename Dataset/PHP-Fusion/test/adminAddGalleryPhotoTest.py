...
driver.find_element(By.XPATH, '//*[@id="gallery_admin"]/li[2]/a').click()
driver.find_element(By.XPATH, '//*[@id="photo_title"]').send_keys("test")
driver.find_element(By.XPATH, '//*[@id="photo_image"]').send_keys(r"D:/MineResearch/datasets/mineDatasets/PHP-Fusion/test/aTestImg.png")
sleep(1)
