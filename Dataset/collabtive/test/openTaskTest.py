...
sleep(1)
driver.find_element(By.XPATH, '//*[@id="donebutn_2"]').click()
sleep(1)
driver.find_element(By.XPATH, '//*[@id="task_1"]/tr/td[2]/div/a').click()
driver.find_element(By.XPATH, '//*[@id="closetoggle"]/a').click()
sleep(1)
