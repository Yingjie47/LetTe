...
driver.find_element(By.XPATH, '//*[@id="users_table_filter"]/label/input').send_keys("admin")
driver.find_element(By.XPATH, '//*[@id="users_table_filter"]/label/input').send_keys(Keys.ENTER)
# sleep(1)
